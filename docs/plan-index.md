...
| Contextual impact analysis | `contextual-impact-implementation-plan.md` + UX spec + hypothesis tree | Experimental advisory implementation complete; corpus-v2 collection pending; promotion blocked | Collect and blindly label 20 development and 20 held-out ranking cases, then run the frozen paired evaluation once |
